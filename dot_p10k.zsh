# Generated by Powerlevel10k configuration wizard on 2021-02-10 at 11:20 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='  '        # separate right segments with two spaces
